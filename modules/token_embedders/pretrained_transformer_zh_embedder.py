...
from whisper.data import PretrainedTransformerZhTokenizer


@TokenEmbedder.register("pretrained_transformer_zh")
class PretrainedTransformerZhEmbedder(TokenEmbedder):
    """
    ...
    def __init__(self, model_name: str, max_length: int = None) -> None:
        ...
        tokenizer = PretrainedTransformerZhTokenizer(model_name)
