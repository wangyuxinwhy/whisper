...
from ..tokenizers import PretrainedTransformerZhTokenizer

logger = logging.getLogger(__name__)


@TokenIndexer.register("pretrained_transformer_zh")
class PretrainedTransformerZhIndexer(TokenIndexer):
    """
    ...
    def __init__(
        ...
        self._allennlp_tokenizer = PretrainedTransformerZhTokenizer(model_name)
    ...
    def __eq__(self, other):
        if isinstance(other, PretrainedTransformerZhIndexer):
